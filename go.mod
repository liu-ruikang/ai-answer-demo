...
require (
	...
	github.com/cloudwego/eino-ext/components/tool/duckduckgo v0.0.0-20250429121045-a2545a66f5cf
...
require (
	...
	github.com/volcengine/volcengine-go-sdk v1.1.17 // indirect
